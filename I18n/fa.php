...
return [
    ...
    'maintenance' => [
        'title' => 'در دست تعمیر',
        'body' => '<h1>ما به زودی برخواهیم گشت!</h1>
    <div>
        <p>در حال حاضر سایت در حال بروزرسانی می‌باشد. لطفا صبور باشید...</p>
    </div>',
    ],
    'not_implemented_yet' => 'پیاده‌سازی نشده است!',
