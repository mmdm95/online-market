...
<div class="message-box">
    <h1><?= \translate()->translate('404.number'); ?></h1>
    <p><?= \translate()->translate('404.message'); ?></p>
    <div class="buttons-con">
        <div class="action-link-wrap">
            <a onclick="history.back(-1)" class="link-button link-back-button">
                <?= \translate()->translate('404.back_btn'); ?>
            </a>
            <a href="<?= url('home'); ?>" class="link-button">
                <?= \translate()->translate('404.home_btn'); ?>
            </a>
        </div>
    </div>
</div>
