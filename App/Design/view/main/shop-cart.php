                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <div class="lng_dropdown mr-2">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="assets/images/ir.png" data-title="فارسی">فارسی</option>
                                <option value='en' data-image="assets/images/eng.png" data-title="انگلیسی">انگلیسی</option>
                                <option value='fn' data-image="assets/images/fn.png" data-title="فرانسوی">فرانسوی</option>
                            </select>
                        </div>
                        <div class="mr-3">
                            <select name="countries" class="custome_select">
            ...
            <nav class="navbar navbar-expand-lg"> 
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="dropdown dropdown-mega-menu">
                            <a class="dropdown-toggle nav-link active" href="#" data-toggle="dropdown">فروشگاه</a>
                            <div class="dropdown-menu">
                                <ul class="mega-menu d-lg-flex">
                                        ...
                                        <ul class="d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-4">
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item active" href="shop-cart.php">سبد خرید</a></li>
                ...
                <form class="field_form shipping_calculator">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            <input required="required" placeholder="کشور" class="form-control" name="name" type="text">
                        </div>
                        <div class="form-group col-lg-6">
