            ...
            <nav class="navbar navbar-expand-lg"> 
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <ul> 
                                    ...
                                    <li><a class="dropdown-item nav-link nav_item" href="static-page.php">شرایط و ضوابط</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle nav-link active" href="#" data-toggle="dropdown">وبلاگ</a>
                            <div class="dropdown-menu dropdown-reverse">
                                <ul>
                                    <li>
                                        <a class="dropdown-item menu-link dropdown-toggler active" href="#">شبکه ای</a>
                                        <div class="dropdown-menu">
                                            <ul> 
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">وبلاگ نوار کناری سمت چپ</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog_post blog_style2 box_shadow1">
                            ...
                            <div class="blog_content bg-white">
                                <div class="blog_text">
                                    <h6 class="blog_title"><a href="blog-single.html">اما باید برای شما توضیح دهم که چگونه این ایده اشتباه است</a></h6>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog_post blog_style2 box_shadow1">
                            ...
                            <div class="blog_content bg-white">
                                <div class="blog_text">
                                    <h6 class="blog_title"><a href="blog-single.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</a></h6>
                                    <ul class="list_none blog_meta">
                                        <li><a href="#"><i class="ti-calendar"></i> 14 اسفند 1399</a></li>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog_post blog_style2 box_shadow1">
                            ...
                            <div class="blog_content bg-white">
                                <div class="blog_text">
                                    <h6 class="blog_title"><a href="blog-single.html">چرا بلیط منچستر بسیار گران است؟</a></h6>
                                    <ul class="list_none blog_meta">
                                        <li><a href="#"><i class="ti-calendar"></i> 14 اسفند 1399</a></li>
            	...
            	<div class="sidebar">
                            ...
                            <li>
                                <div class="post_footer">
                                    ...
                                    <div class="post_content">
                                        ...
                                        <p class="small m-0">14 اسفند 1399</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="widget">
                        ...
                        <ul class="widget_archive">
                            <li><a href="#"><span class="archive_year">بهمن 1399</span><span class="archive_num">(12)</span></a></li>
                            <li><a href="#"><span class="archive_year">دی 1399</span><span class="archive_num">(5)</span></a></li>
                            <li><a href="#"><span class="archive_year">آذر 1399</span><span class="archive_num">(6)</span></a></li>
                            <li><a href="#"><span class="archive_year">آبان 1399</span><span class="archive_num">(7)</span></a></li>
                            <li><a href="#"><span class="archive_year">مهر 1399</span><span class="archive_num">(10)</span></a></li>
                        </ul>
                    </div>
                    <div class="widget">
                    	<div class="shop_banner">
