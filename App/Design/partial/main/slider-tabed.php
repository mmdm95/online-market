                        ...
                        <ul class="nav nav-tabs justify-content-center justify-content-md-end" id="tabmenubar"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="arrival-tab" data-toggle="tab" href="#arrival"
                                   role="tab" aria-controls="arrival" aria-selected="true">محصول جدید</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme nav_style1"
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">لباس آبی
                                                زنانه</a></h6>
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">کت اسپرت
                                                خاکستری</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">لباس کامل
                                                زنانه</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">پیراهن آبی
                                                روشن</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">پیراهن
                                                چهارخونه</a></h6>
                                        <div class="product_price">
                                            <span class="price">55000 تومان</span>
                                            <del>95000 تومان</del>
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">لباس زنانه</a>
                                        </h6>
                                        <div class="product_price">
                                            <span class="price">68000 تومان</span>
                                            <del>99000 تومان</del>
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">پیراهن جین
                                                آبی</a></h6>
                                        <div class="product_price">
                                            <span class="price">69000 تومان</span>
                                            <del>89000 تومان</del>
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme nav_style1"
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">تی شرت
                                                دخترانه</a></h6>
                                        <div class="product_price">
                                            <span class="price">45000 تومان</span>
                                            <del>55000 تومان</del>
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">تی شرت مشکی
                                                زنانه</a></h6>
                                        <div class="product_price">
                                            <span class="price">68000 تومان</span>
                                            <del>99000 تومان</del>
